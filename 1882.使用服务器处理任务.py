    ...
    def assignTasks(self, servers: List[int], tasks: List[int]) -> List[int]:
        ...
        def release():
            while busy and busy[0][0] <= ts:
                sid = heapq.heappop(busy)[1]
                heapq.heappush(idle, [servers[sid], sid])
