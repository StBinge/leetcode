...
class Solution:
    def waysToBuildRooms(self, prevRoom: List[int]) -> int:
        ...
        inv=[1]*N
        for f in range(1, N):
            factorial[f] = (f * factorial[f-1])%Mod
            inv[f]=pow(factorial[f],Mod-2,Mod)
